  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          'fixed bottom-0 top-20 z-10 hidden h-[calc(100svh-4rem)] w-(--sidebar-width) transition-[left,right,width] duration-200 ease-linear md:flex',
          side === 'left'
...
function SidebarTrigger({ className, onClick, ...props }: React.ComponentProps<typeof Button>) {
  ...
  return (
    <Button
      ...
      {...props}
    >
      <PanelLeftIcon className="size-9 [&_svg]:size-6 " />
